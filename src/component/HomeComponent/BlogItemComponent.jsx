...
const BlogItemComponent = ({ retweet = false }) => {
  return (
    <Link to="/blog">
      <div
        className={`px-4 py-2 rounded-md hover:bg-gray-100 border ${
          retweet ? "" : "bg-white"
        }`}
      >
        {/* header Blog */}
        ...
        <div className="grid grid-cols-3 gap-4 py-2 ">
          <div className="col-span-2">
            ...
            <p className="overflow-y-auto max-h-48">
              ...
              Voluptates eos perspiciatis optio esse, ratione, unde placeat
              deleniti aliquam itaque deserunt velit corporis, voluptatem
              architecto quibusdam rem perferendis est! Magnam, perspiciatis?..
            </p>
          </div>
